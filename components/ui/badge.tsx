...
const badgeVariants = cva(
  "inline-flex items-center justify-centre rounded-full border text-xs  transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
